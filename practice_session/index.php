...
<head>
  ...
  <link rel="stylesheet" href="./style.css?v=20260530-8">
</head>
<body>
  <header class="practice-header">
    <a class="brand" href="/">
      <img src="/assets/img/logo.png" alt="ARRIBA SOCCER CLUB">
    </a>
  ...
  <main>
    ...
    <section class="form-section" id="form">
      ...
      <form class="practice-form" action="./submit.php" method="post">
        ...
        <div class="notice wide">
          <p>※ご注意</p>
          <ul>
            <li>お申し込みいただきました個人情報については、ARRIBAサッカークラブにて適切に管理し、ARRIBAサッカークラブからのご連絡及びイベントのご案内以外には利用しません。</li>
            <li>体験中はアリバコーチ、スタッフからのコーチング及び運営に関する指示の遵守をお願いします。</li>
            <li>体験にお越しの際はサッカーが出来る服装、レガース及び水筒等をご持参下さい。</li>
            <li>体験中のけが等についてARRIBAサッカークラブは一切責任を負いません。自己の責任において対応をお願いします。</li>
          </ul>
        </div>
